                            ...
                            <div className='  px-4 md:px-0 mb-16'>
                                ...
                                <div className=" flex justify-end">
                                    <button
                                        onClick={add}
                                        type="button"
                                        className="focus:outline-none text-white bg-green-500 shadow-[inset_0_0_10px_rgba(0,0,0,0.6)] border hover:bg-pink-700 outline-0 font-medium rounded-lg text-sm px-5 py-2.5 mb-2" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} > <div className="flex gap-2 items-center">
                        ...
                        <TabPanel>
                            ...
                            <div className="relative overflow-x-auto mb-16">
                                ...
                                {order && order?.map((allorder,index)=>{
                                    ...
                                    {allorder && allorder?.cartItems && allorder?.cartItems.map((item,index)=>{
